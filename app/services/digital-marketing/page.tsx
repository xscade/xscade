...
const services = [
  ...
  },
  {
    ...
    description: "Build your brand presence and engage with your audience on all major platforms."
  },
  {
    icon: FileText,
  ...
  },
  {
    ...
    description: "Track performance with comprehensive analytics and data-driven insights."
  },
  {
    icon: Target,
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Drive growth, increase visibility, and connect with your audience through 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Comprehensive solutions to grow your online presence and drive business results
            </p>
          </motion.div>
